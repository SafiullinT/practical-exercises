...
ostream& operator<<(ostream& out, Truncated_Cone cone)
{
    out << endl;
    out << "Координаты центра: (" << cone.x << ", " << cone.y << ", " << cone.z << ")" << endl;
    out << "Радиус основания: " << cone.radius << endl;
    out << "Радиус верхней поверхности: " << cone.radius2 << endl;
    out << "Высота: " << cone.height << endl;
    out << "Площадь полной поверхности: " << cone.area() << endl;
    out << "Объем: " << cone.volume() << endl;

    return out;
}

istream& operator>>(istream& in, Truncated_Cone cone)
{
    cout << "Введите координаты центра (x,y,z): ";
	in >> cone.x >> cone.y >> cone.z;
	cout << "Введите радиус основания: ";
	in >> cone.radius;
	cout << "Введите радиус верхней поверхности: ";
	in >> cone.radius2;
	cout << "Введите высоту: ";
	in >> cone.height;
	return in;
